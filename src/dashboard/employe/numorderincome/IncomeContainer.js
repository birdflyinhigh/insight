  ...
  render(){
    ...
    return <div className="hr-bg">
			<div className="dash-container">
				...
				<SecPanel data={pannelData} defaultValue="income" jumpFn={this.jumpFn.bind(this)}/>
        <ChartsPart data={this.props} title={EmployPageTitles.income} showUnit={true}/>
			</div>
		</div>
  }
}