...
import {OrgIndex, PathInfo} from './constant';
      ...
      <div className="hr-container">
        ...
        <div className="mdetail-container">
          <p style={{fontSize: 16}}>
            ...
            <span style={{paddingLeft: 20}}>{state.query1}</span>
            <span style={{paddingLeft: 20}}>{state.query2 ? state.query2 : state.query2}</span>
          ...
          <div className="financial-table">
            <Table columns={OrgIndex} pagination={false}
