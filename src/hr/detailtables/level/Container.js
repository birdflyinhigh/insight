...
function mapStateToProps(state){
  return {...state.statetree.levelTable};
}
...
export default class Keyposition extends Component{
  constructor(props){
    ...
    this.queryParams = {
      ...
      poLevel: this.props.location.state ? this.props.history.location.state.specificId : "",
      pageNum: 1,
      pageSize: 15,
    }
    this.state = {
  ...
  downloadData(){
    CommonMethod.download( "erp/hr/exportStaffLevel",this.queryParams);
  }
  render(){
