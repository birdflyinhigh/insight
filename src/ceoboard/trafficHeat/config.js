...
export const BottomIntroText= "（1）店铺有效UV：非直访UV均为有效流量，直访到店铺的流量占店铺整体UV的比例超过30%时记直访UV的30%为有效；</br>" +
    "（2）可支撑权益工位数：店铺有效UV / 3</br>" +
    "（3）商家版工位数：即商家版工场会员工位数，取所选时间中最后一天状态下的数据；</br>" +
    "（4）售卖比例：商家工位数 / 可支撑权益工位数；</br>"+
    "（5）潜在需求量：地区&类目下订单提交量 + 地区&类目下搜索次数*搜索转化率 ；</br>" +
    "（6）工场会员服务商数：工场会员的服务商数量，地区按服务商购买商家版工场会员的地区来划分（包括本地与漫游），一个服务商可能复记在多个地区；类目按服务商主营类目划分；";